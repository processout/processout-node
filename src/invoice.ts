...
class Invoice {
     ...
     * @return {Invoice}
     */
    public setProject(val: any): Invoice {
     ...
     * @return {Invoice}
     */
    public setTransaction(val: any): Invoice {
        if (val.getProcessOutObjectClass &&
     ...
     * @return {Invoice}
     */
    public setCustomer(val: any): Invoice {
        if (val.getProcessOutObjectClass &&
     ...
     * @return {Invoice}
     */
    public setSubscription(val: any): Invoice {
        if (val.getProcessOutObjectClass &&
     ...
     * @return {Invoice}
     */
    public setToken(val: any): Invoice {
        if (val.getProcessOutObjectClass &&
     ...
     * @return {Invoice}
     */
    public setRisk(val: any): Invoice {
        if (val.getProcessOutObjectClass &&
     ...
     * @return {Invoice}
     */
    public setShipping(val: any): Invoice {
        if (val.getProcessOutObjectClass &&
     ...
     * @return {Invoice}
     */
    public setDevice(val: any): Invoice {
        if (val.getProcessOutObjectClass &&
