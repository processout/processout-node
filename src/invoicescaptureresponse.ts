...
class InvoicesCaptureResponse {
     ...
     * @return {InvoicesCaptureResponse}
     */
    public setTransaction(val: p.Transaction): InvoicesCaptureResponse {
     ...
     * @return {InvoicesCaptureResponse}
     */
    public setCustomerAction(val: p.CustomerAction): InvoicesCaptureResponse {
        if (val.getProcessOutObjectClass &&
     ...
     * @return {InvoicesCaptureResponse}
     */
    public fillWithData(data: any): InvoicesCaptureResponse {
        if (data["transaction"])
