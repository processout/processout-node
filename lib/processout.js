...
var ProcessOut = /** @class */ (function () {
     ...
     */
    ProcessOut.prototype.newPaymentProcessingConfiguration = function (prefill) {
     ...
     */
    ProcessOut.prototype.newAPMPaymentProcessingConfiguration = function (prefill) {
     ...
     * @return {Submerchant}
     */
    ProcessOut.prototype.newSubmerchant = function (prefill) {
     ...
     */
    ProcessOut.prototype.newSubmerchantMapping = function (prefill) {
     ...
     */
    ProcessOut.prototype.newCardSchemeDetails = function (prefill) {
