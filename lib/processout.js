...
var ProcessOut = module.exports = Base.extend({
     ...
     * @return {InvoiceRisk}
     */
	newInvoiceRisk: function(prefill) {
     ...
     */
	newInvoiceDevice: function(prefill) {
     ...
     */
	newInvoiceShipping: function(prefill) {
     ...
     * @return {PayoutItem}
     */
	newPayoutItem: function(prefill) {
     ...
     */
	newPaymentDataThreeDSRequest: function(prefill) {
     ...
     */
	newPaymentDataNetworkAuthentication: function(prefill) {
     ...
     */
	newPaymentDataThreeDSAuthentication: function(prefill) {
