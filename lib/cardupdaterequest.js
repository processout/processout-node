...
var CardUpdateRequest = /** @class */ (function () {
     ...
     * @return {CardUpdateRequest}
     */
    CardUpdateRequest.prototype.setPreferredScheme = function (val) {
     ...
     * @return {string}
     */
    CardUpdateRequest.prototype.getPreferredCardType = function () {
     ...
     * @return {CardUpdateRequest}
     */
    CardUpdateRequest.prototype.setPreferredCardType = function (val) {
     ...
     */
    CardUpdateRequest.prototype.getSchemeDetails = function () {
     ...
     * @return {CardUpdateRequest}
     */
    CardUpdateRequest.prototype.setSchemeDetails = function (val) {
     ...
     * @return {Promise<any>}
     */
    CardUpdateRequest.prototype.update = function (cardId, options) {
        if (!options)
            options = {};
...
module.exports = CardUpdateRequest;
//# sourceMappingURL=cardupdaterequest.js.map