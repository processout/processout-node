...
var Token = /** @class */ (function () {
    ...
    function Token(client, prefill) {
         ...
         * @type {boolean}
         */
        this.manualInvoiceCancellation = null;
        /**
         ...
         * @type {boolean}
         */
        this.provisionNetworkToken = null;
     ...
     * @return {p.Invoice}
     */
    Token.prototype.getInvoice = function () {
        return this.invoice;
    };
    /**
     * Set Invoice
     ...
     * @return {Token}
     */
    Token.prototype.setInvoice = function (val) {
        if (val.getProcessOutObjectClass &&
     ...
     * @return {string}
     */
    Token.prototype.getInvoiceId = function () {
     ...
     * @return {Token}
     */
    Token.prototype.setInvoiceId = function (val) {
        this.invoiceId = val;
        return this;
    };
    /**
     ...
     * @return {boolean}
     */
    Token.prototype.getManualInvoiceCancellation = function () {
     ...
     * @return {Token}
     */
    Token.prototype.setManualInvoiceCancellation = function (val) {
     ...
     * @return {string}
     */
    Token.prototype.getVerificationStatus = function () {
     ...
     * @return {Token}
     */
    Token.prototype.setVerificationStatus = function (val) {
     ...
     * @return {boolean}
     */
    Token.prototype.getCanGetBalance = function () {
     ...
     * @return {Token}
     */
    Token.prototype.setCanGetBalance = function (val) {
     ...
     * @return {string}
     */
    Token.prototype.getWebhookUrl = function () {
     ...
     * @return {Token}
     */
    Token.prototype.setWebhookUrl = function (val) {
        this.webhookUrl = val;
        return this;
    };
    /**
     ...
     * @return {boolean}
     */
    Token.prototype.getProvisionNetworkToken = function () {
     ...
     * @return {Token}
     */
    Token.prototype.setProvisionNetworkToken = function (val) {
    ...
    Token.prototype.create = function (options) {
        ...
        return new Promise(function (resolve, reject) {
            var callback = function (resp) {
                return __awaiter(this, void 0, void 0, function () {
                    var respBody, err_3, response, err, returnValues, body, body, obj1, obj1Filled;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                respBody = {};
