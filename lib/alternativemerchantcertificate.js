...
var AlternativeMerchantCertificate = /** @class */ (function () {
    /**
     * AlternativeMerchantCertificate constructor
     * @param {ProcessOut} client
     * @param {array} prefill (optional)
     */
    function AlternativeMerchantCertificate(client, prefill) {
        this.client = null;
        /**
    ...
    AlternativeMerchantCertificate.prototype.getProcessOutObjectClass = function () {
     ...
     * @return {string}
     */
    AlternativeMerchantCertificate.prototype.getId = function () {
        return this.id;
    };
    /**
     * Set Id
     ...
     * @return {AlternativeMerchantCertificate}
     */
    AlternativeMerchantCertificate.prototype.setId = function (val) {
        this.id = val;
        return this;
    };
    /**
     ...
     * @return {AlternativeMerchantCertificate}
     */
    AlternativeMerchantCertificate.prototype.fillWithData = function (data) {
        if (data["id"])
            this.setId(data["id"]);
        return this;
    };
     ...
     * @return {any}
     */
    AlternativeMerchantCertificate.prototype.toJSON = function () {
        return {
            "id": this.getId(),
        };
    };
     ...
     */
    AlternativeMerchantCertificate.prototype.save = function (options) {
        if (!options)
            options = {};
     ...
     */
    AlternativeMerchantCertificate.prototype.delete = function (options) {
        if (!options)
            options = {};
        this.fillWithData(options);
        var request = new Request(this.client);
...
module.exports = AlternativeMerchantCertificate;
//# sourceMappingURL=alternativemerchantcertificate.js.map