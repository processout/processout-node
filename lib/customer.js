...
var Customer = /** @class */ (function () {
     ...
     * @return {Customer}
     */
    Customer.prototype.setCompanyName = function (val) {
     ...
     * @return {Customer}
     */
    Customer.prototype.setPhone = function (val) {
        if (val.getProcessOutObjectClass &&
     ...
     * @return {string}
     */
    Customer.prototype.getRegisteredAt = function () {
     ...
     * @return {Customer}
     */
    Customer.prototype.setRegisteredAt = function (val) {
     ...
     * @return {string}
     */
    Customer.prototype.getDateOfBirth = function () {
     ...
     * @return {Customer}
     */
    Customer.prototype.setDateOfBirth = function (val) {
     ...
     * @return {string}
     */
    Customer.prototype.getReferenceId = function () {
     ...
     * @return {Customer}
     */
    Customer.prototype.setReferenceId = function (val) {
    ...
    Customer.prototype.create = function (options) {
        ...
        return new Promise(function (resolve, reject) {
            var callback = function (resp) {
                return __awaiter(this, void 0, void 0, function () {
                    var respBody, err_6, response, err, returnValues, body;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                respBody = {};
    ...
    Customer.prototype.delete = function (options) {
        ...
        return new Promise(function (resolve, reject) {
            var callback = function (resp) {
                return __awaiter(this, void 0, void 0, function () {
                    var respBody, err_9, response, err, returnValues;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                respBody = {};
