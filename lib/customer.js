...
var Customer = module.exports = Base.extend({
    ...
    recurringInvoices: function(options) {
        ...
        var path    = "/customers/" + encodeURI(this.getCustomerId()) + "/recurring-invoices";
    ...
    token: function(tokenId, options) {
        var request = new RequestProcessoutPrivate(this._instance);
        var path    = "/customers/" + encodeURI(this.getCustomerId()) + "/tokens/" + encodeURI(tokenId) + "";
     ...
     * @return Token
     */
    delete: function(tokenId, options) {
        var request = new RequestProcessoutPrivate(this._instance);
        var path    = "/customers/" + encodeURI(this.getCustomerId()) + "/tokens/" + encodeURI(tokenId) + "";
    ...
    save: function(options) {
        var request = new RequestProcessoutPrivate(this._instance);
        var path    = "/customers/" + encodeURI(this.getCustomerId()) + "";
