...
var Authorization = module.exports = Base.extend({
    _instance: null,
    ...
    customer: function(options) {
        ...
        var path    = "/authorizations/" + encodeURI(this.getAuthorizationId()) + "/customers";
    ...
    authorize: function(gatewayName, name, token, options) {
        var request = new RequestProcessoutPrivate(this._instance);
        var path    = "/authorizations/" + encodeURI(this.getAuthorizationId()) + "/gateways/" + encodeURI(gatewayName) + "/tokens";
    ...
    create: function(customerId, options) {
        ...
        return new Promise(function(resolve, reject) {
            req.on('complete', function(result, r) {
                ...
                var obj = new Authorization(cur._instance);
                return resolve(obj.fillWithData(body));
     ...
     * @return this
     */
    find: function(authorizationId, options) {
        var request = new RequestProcessoutPrivate(this._instance);
        var path    = "/authorizations/" + encodeURI(authorizationId) + "";
    ...
    create: function(customerId, options) {
        var request = new RequestProcessoutPrivate(this._instance);
        var path    = "/customers/" + encodeURI(customerId) + "/authorizations";
    ...
    find: function(authorizationId, options) {
        ...
        return obj.find(authorizationId, options);
    },
