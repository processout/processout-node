...
var Card = module.exports = Base.extend({
     ...
     * @return {string}
     */
    getCoScheme: function() {
        return this._coScheme;
    },
     ...
     * @return {Card}
     */
    setPreferredScheme: function(val) {
        this._preferredScheme = val;
        return this;
    },
