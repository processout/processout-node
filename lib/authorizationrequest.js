...
var AuthorizationRequest = module.exports = Base.extend({
    ...
    customer: function(options) {
        ...
        var path    = "/authorization-requests/" + encodeURI(this.getAuthorizationRequestId()) + "/customers";
    ...
    authorize: function(gatewayName, name, token, options) {
        var request = new RequestProcessoutPrivate(this._instance);
        var path    = "/authorization-requests/" + encodeURI(this.getAuthorizationRequestId()) + "/gateways/" + encodeURI(gatewayName) + "/tokens";
