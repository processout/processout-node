...
declare class Transaction {
     ...
     * @return {Transaction}
     */
    setProject(val: any): Transaction;
    /**
     * Get ProjectId
     * ID of the project to which the transaction belongs
     * @return {string}
     ...
     * @return {Transaction}
     */
    setInvoice(val: any): Transaction;
    /**
     * Get InvoiceId
     * ID of the invoice used to generate this transaction, if any
     * @return {string}
     ...
     * @return {Transaction}
     */
    setCustomer(val: any): Transaction;
    /**
     * Get CustomerId
     * ID of the customer that was linked to the transaction, if any
     * @return {string}
     ...
     * @return {Transaction}
     */
    setSubscription(val: any): Transaction;
    /**
     * Get SubscriptionId
     * ID of the subscription to which the transaction belongs, if any
     * @return {string}
     ...
     * @return {Transaction}
     */
    setGatewayConfiguration(val: any): Transaction;
    /**
