...
var Invoice = module.exports = Base.extend({
     ...
     * @return this
     */
    setRecurringInvoice: function(val) {
        if (typeof val === 'object')
            this._recurringInvoice = val;
        else {
            var obj = new RecurringInvoice(this._instance);
            obj.fillWithData(val);
            this._recurringInvoice = obj;
        }
        return this;
    },
    ...
    customer: function(options) {
        ...
        var path    = "/invoices/" + encodeURI(this.getInvoiceId()) + "/customers";
     ...
     * @return bool
     */
    charge: function(tokenId, options) {
        var request = new RequestProcessoutPrivate(this._instance);
        var path    = "/invoices/" + encodeURI(this.getInvoiceId()) + "/tokens/" + encodeURI(tokenId) + "/charges";
    ...
    tokens: function(options) {
        var request = new RequestProcessoutPrivate(this._instance);
        var path    = "/invoices/" + encodeURI(this.getInvoiceId()) + "/tokens";
    ...
    lock: function(options) {
        var request = new RequestProcessoutPrivate(this._instance);
        var path    = "/invoices/" + encodeURI(this.getInvoiceId()) + "";
