...
var Invoice = module.exports = Base.extend({
     ...
     * @return {string}
     */
    getMerchantInitiatorType: function() {
        return this._merchantInitiatorType;
    },
     ...
     * @return {Invoice}
     */
    setMerchantInitiatorType: function(val) {
        this._merchantInitiatorType = val;
        return this;
    },
    ...
    setRisk: function(val) {
        if (typeof val.getClass === "function" &&
            val.getClass() == this._client.newInvoiceRisk().getClass())
            this._risk = val;
        else {
            var obj = this._client.newInvoiceRisk();
            obj.fillWithData(val);
            this._risk = obj;
        }
        return this;
    ...
    setShipping: function(val) {
        if (typeof val.getClass === "function" &&
            val.getClass() == this._client.newInvoiceShipping().getClass())
            this._shipping = val;
        else {
            var obj = this._client.newInvoiceShipping();
            obj.fillWithData(val);
            this._shipping = obj;
        }
        return this;
    ...
    setDevice: function(val) {
        if (typeof val.getClass === "function" &&
            val.getClass() == this._client.newInvoiceDevice().getClass())
            this._device = val;
        else {
            var obj = this._client.newInvoiceDevice();
            obj.fillWithData(val);
            this._device = obj;
        }
        return this;
